...
g_pod_path = '../../ZhuiYinFramework/ZhuiYinFramework/ThirdParty'
g_add_method_pre = 'zyfunc_'
g_add_method_suf = '_method'
g_ignore_classname = ['pbobjc']
g_ignore_dirs = ['Pods','UnUsedFiles','NewWebApp','proto','LeakCheck','MobEnt','originproto','OrangeFilter']
g_ignore_header_dirs = ['Pods','NewWebApp','proto','LeakCheck','MobEnt','originproto','OrangeFilter']
g_ignore_rename_dires = ['Pods','UnUsedFiles','proto','originproto','OrangeFilter']
g_ignore_method_pre = ['mb_', 'zy_', 'zymethod_', g_add_method_pre, 'mas_']
...
def findAllTargetClasses():
    allFilePaths = fileObject.recursiveDir(g_pod_path, ['.m'])
    targetClasses = []
    for filePath in allFilePaths:
        fileName = os.path.basename(filePath)
        for className in g_ignore_classname:
            if className not in fileName:
